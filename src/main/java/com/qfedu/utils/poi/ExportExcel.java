...
public class ExportExcel {
     ...
     * 参数: headers[表格每一列的列名]
     * 参数: dataSet[要导出的数据源]
     * 参数: resultUrl[导出的excel文件地址,如果为null,则response必须不为null。否则抛异常导出失败。]
     * 参数: response[可以选择响应到浏览器，如果为null,则输出到本地文件(resultUrl)]
     ...
     * 功能:真正实现导出
     */
    private static void doExportExcel(String sheetName,String titleName,String[] headers,Collection<?> dataSet,String resultUrl,HttpServletResponse response,String pattern) throws Exception {
